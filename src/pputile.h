...
if (atrib & 0x20) {
				if (atrib & 0x40) {
					P[7] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[6] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[5] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[4] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[3] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[2] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[1] = S[pixdata & 0xF] | 0x80;
					pixdata >>= 4;
					P[0] = S[pixdata] | 0x80;
